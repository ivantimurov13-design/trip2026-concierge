...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const instructions = [
      ...
      'Приоритеты: семейная логистика, дети, коляска, правило одного большого дела, гастрономия, спокойный темп, День Короля в Амстердаме и день посольства в Варшаве.',
      ...
      'Если спрашивают про расходы, опирайся на бюджет из контекста и прямо говори, где суммы округлены.',
